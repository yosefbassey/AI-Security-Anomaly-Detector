# 🛡️ AI Security Anomaly Detector

> "Science is about finding the truth hidden in the data."
...
1.  **Data Generation:** We simulate a dataset of 1,020 users (1,000 normal villagers + 20 malicious actors).
